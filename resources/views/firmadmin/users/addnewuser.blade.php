...
<section class="section">
  ...
  <div class="section-body">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
        <form action="{{ url('firm/users/create_user1') }}" method="post" class="needs-validation" novalidate="">
          <div class="card-body">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                @csrf
                <button class="btn btn-primary" type="submit" name="create_firm_user" value="Create and Add More">
                  <span>Save and Add More</span>
                </button>
                <button class="btn btn-primary" type="submit" name="create_firm_user" value="Save and Exit">
                  <span>Save and Exit</span>
                </button>
                <a href="{{url('firm/payment_method2')}}" class="btn btn-primary">Exit</a>
              </div>
            </div>
          </div>
        </form>
