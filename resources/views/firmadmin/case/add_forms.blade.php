...
<!--new-header Close-->
  <div class="section-body">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
        <form action="{{ url('firm/case/create_case_form') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
          <div class="back-btn-new">
            <a href="{{ url('firm/case/case_forms') }}/{{$case->id}}">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7 information-form-data">
                <select class="form-control family_arr" style="width: 220px;" name="client_id" data-live-search="true">
                  ...
                  if(!empty($client)) {
                    ...
                    echo '<option value="'.$client->user_id.'">'.$cname.'</option>';
                  } 
                  $farr = array();
