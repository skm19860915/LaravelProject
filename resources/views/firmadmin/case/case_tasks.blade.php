          ...
          <div class="card-header">
           ...
           <div class="card-body">
             ...
             <div class="profile-new-client">
               ...
               <a href="{{ url('firm/case/add_case_tasks')}}/{{$case->id}}" class="add-task-link">Create Tasks</a>
               <?php } else { ?>
                <!-- <a href="{{ url('firm/case/add_case_tasks')}}/{{$case->id}}" class="add-task-link">Upgrade to create a task</a> -->
                <?php } ?>
               <div class="table-box-task">
                <div class="table-responsive table-invoice">
                   <table class="table table-striped" id="rktable">
                     <thead>
                       <tr>
                         <th>Task ID</th>
                         <th>Tasks</th>
                      ...
                      if(!empty($task)) {
                       ...
                       <tr>
                         ...
                         <td>
                          <?php 
                          if($firm->account_type == 'CMS') { ?>
                           <a href="{{url('firm/case/edit_case_tasks')}}/{{ $case->id }}/{{$v->id}}" class="action_btn" title="Edit" data-toggle="tooltip"><img src="{{ url('/') }}/assets/images/icon/pencil(1)@2x.png"></a>
                         <?php } ?>
                         </td>
                       </tr>
                      <?php } } ?>
