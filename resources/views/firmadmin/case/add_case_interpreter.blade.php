...
<!--new-header Close-->
  <div class="section-body">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
        <form action="{{ url('firm/case/create_derivative_incase') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
          ...
          <div class="card-body">
            ...
            <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <input type="hidden" name="type" value="interpreter">
  ...
  $('.addexistingmember').on('click', function(e){
    ...
    if(v != '') {
      ...
      $.ajax({
        ...
        data: { family_id: v, _token:_token, case_id:  "{{$id}}", type : type},
        success:function(res)
        {       
