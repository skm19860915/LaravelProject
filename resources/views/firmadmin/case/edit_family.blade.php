          ...
          <div class="card-body">
            ...
            <div class="row">
             ...
             <div class="form-client-edit-input">
              <div class="row">
               ...
               <div class="col-md-8 col-sm-8 col-xs-12">
                <input type="text" placeholder="Cell Phone" name="phon_number" class="form-control phone_us cls_{{$readonly}}" value="{{$FamilyMember->phon_number}}" {{$readonly}}>                 
               </div>
              </div>
              </div>
             </div>
            ...
            <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <?php } ?>
              <input type="hidden" name="redirecturl" value="{{ url('firm/case/case_family') }}/{{$id}}">
