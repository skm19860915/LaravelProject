                    ...
                    <thead>
                      ...
                      <tr>
                       <td> <label class="custom-switch mt-2">
                          ...
                          <input type="checkbox" name="payment_cycle" class="custom-switch-input annual_payment_cycle1" value="1" checked data-monthly_amount="{{$firm->usercost}}" data-tu="<?php if($viewamount) { echo $c+1; } else { echo $c; }; ?>">
