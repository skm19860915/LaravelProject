...
<section class="section invoice_list_view">
  <div class="section-header">
    <h1><a href="{{route('firm.billing')}}"><span>Firm Billing / </span></a> Scheduled</h1>
  </div>
                ...
                <div class="profle-text-section">
                  <div class="task-tabbtn-box">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" data-status="1" id="scheduled-tab" data-toggle="tab" href="{{ url('firm/billing/scheduled') }}" role="tab" aria-controls="scheduled" aria-selected="false">Scheduled</a>
                      </li> 
                      <li class="nav-item">
                  ...
                  <div class="task-tabcontent-box">
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="scheduled" role="tabpanel" aria-labelledby="home-tab">
                        <div class="table-responsive table-invoice scheduled-table-width invoice-table-width invoice_width_table">
...
var index_url = "{{route('firm.billing.getScheduledInvoiceData')}}";
      ...
      columns: [
        ...
        { data: 'client_name', name: 'client_name'},
        {
          ...
          render: function(data) {
            return '<a href="'+data.link+'">'+data.client_name+'</a>';
          }, orderable: "false"
        },
        ...
        { data: 'recurring_amount', name: 'recurring_amount'},
