          ...
          <div class="card-header">
           ...
           <div class="card-body">
             ...
             <div class="profile-new-client">
               ...
               <div class="profle-text-section">
                <div class="task-tabbtn-box">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" data-status="0" id="summary-tab" data-toggle="tab" href="{{ url('firm/client/client_billing') }}/{{$client->id}}" role="tab" aria-controls="summary" aria-selected="true">Summary</a>
                    </li>
                    <li class="nav-item">
                      ...
                      if(!empty($scheduled)) {
                        foreach ($scheduled as $k => $v) { 
                          ...
                          <tr>
                             ...
                             td>$<?php echo $v->recurring_amount; ?></td>
              ...
              <h4 class="margin-top-35">Payment History</h4>
              <div class="table-box-task">
                <div class="table-responsive table-invoice billing-admin-client">
                   <table class="table table-striped">
                     <thead>
                       <tr>
                         <th>Invoice Number</th>
