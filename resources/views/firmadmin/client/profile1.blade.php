                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$client->user_id}}?action=download" class="action_btn doclinkp doclinkpdd" target="_blank" title="Download" data-toggle="tooltip">
                              ...
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$client->user_id}}?action=print" class="action_btn doclink2 doclinkp doclinkppp" target="_blank" title="Print" data-toggle="tooltip">
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="height: 85%; fill: #949DB2;">
                                  <g>
