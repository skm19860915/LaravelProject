   ...
   <div class="row">
      <div class="col-md-3">
        ...
        <ul class="sidebar-menu chatuser">
            ...
            <li><a href="{{ route('firm.clientchat.chat', [ 'ids' => auth()->user()->id  . '-' . $user->id ]) }}" class="list-group-item list-group-item-action">{{ $user->name }}
            <span class="text-gray"><?php if($user->role_id == 4) {
                            echo '(Firm Admin)';
                        }
