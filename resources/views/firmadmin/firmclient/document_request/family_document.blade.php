                ...
                <div class="card">
                    <div class="card-header">
                      <div class="back-btn-new" style="padding-top: 0; padding-left: 0;">
                        <a href="{{ url('firm/clientcase/casefamily') }}/{{$case->case_id}}">
...
<div class="modalformpart modal-document_request" id="modal-form-part" style="display: none;">
  <form action="{{url('firm/firmclient/document_request/setFamilyDataDocument')}}" method="post" enctype="multipart/form-data" class="dropzone1" id="mydropzone1">
    <div class="row">
      <!-- <div class="col-md-12">
        File * 
      </div> -->
    ...
    <div class="row">  
      <div class="col-md-12 text-right">
        ...
        <input type="hidden" name="fid" class="" value="{{$fid}}">
...
var index_url = "{{url('firm/firmclient/document_request/getFamilyDataDocument1')}}/{{$case->case_id}}/{{$fid}}";
var srn = 0;
$(window).on('load', function() {
      ...
      columns: [
        ...
        { data: null,
          render: function(data){
            ...
            var view_button = ' <a href="#" data-id="'+data.did+'" data-files="'+data.document+'" class="action_btn viewdocbtn"><img src="{{ url('/') }}/assets/images/icon/pencil(1)@2x.png"></a>';
    ...
    //   url: "{{url('firm/document_request/setDataDocument')}}"
    // });
