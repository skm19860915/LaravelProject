        ...
        <div class="card">
          <div class="card-header">
            <div class="back-btn-new" style="padding-top: 0; padding-left: 0;">
              <a href="{{ url('firm/clientcase/casetasks') }}/{{$case->case_id}}">
          ...
          <div class="card-body">
            <div class="profile-new-client">
              <form action="{{ url('firm/clientcase/insert_newtask') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <input type="hidden" name="id" value="{{ $case->case_id }}" > 
