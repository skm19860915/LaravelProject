  ...
  <div class="section-body">
     ...
     <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
           <form action="{{url('firm/document_request/setClientDataDocument1')}}" method="post" enctype="multipart/form-data" class="dropzone1" id="mydropzone1">
            <div class="row">
            ...
            <div class="row">  
              <div class="col-md-12 text-left upload-btn-save">
                ...
                <input type="hidden" name="family_id"  value="{{$client->user_id}}">
