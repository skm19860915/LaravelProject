...
@section('content')
<section class="section client-listing-details client-forms-new">
          ...
          <div class="card">
            <div class="card-body">
              <div class="profile-new-client">
               ...
               <a href="{{ url('firm/form/addform/')}}/{{$client->id}}" class="add-task-link">Add New Form</a>
