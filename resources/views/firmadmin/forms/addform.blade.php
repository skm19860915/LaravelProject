...
<!--new-header Close-->
  <div class="section-body">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
        <form action="{{ url('firm/forms/create_form') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
          <div class="back-btn-new">
            <a href="{{ url('firm/forms') }}/{{$client->id}}">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                ...
                <!-- <input type="text" placeholder="Case Number" name="case" class="form-control" >  -->
              </div>
            </div>
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                @csrf
                <input type="hidden" name="firm_id" value="{{$data->firm_id}}">
