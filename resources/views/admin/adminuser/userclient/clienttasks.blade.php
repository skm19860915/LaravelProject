        ...
        <div class="card">
           <div class="card-body">
             ...
             <div class="profile-new-client">
               <h2>Tasks</h2>
               <a href="{{ url('admin/userclient/addclienttask')}}/{{$client->user_id}}" class="add-task-link">Create Tasks</a>
                   ...
                   <table class="table table-striped">
                     ...
                     <tbody>
                      ...
                      if(!empty($task)) {
                        foreach ($task as $k => $v) { ?>
                       <tr>
                         <td><a href="{{url('admin/userclient/editclienttask')}}/{{ $client->user_id }}/{{$v->id}}">#<?php echo $v->id; ?></a></td>
                         ...
                         <td>
                           <a href="{{url('admin/userclient/editclienttask')}}/{{ $client->user_id }}/{{$v->id}}" class="action_btn" title="Edit" data-toggle="tooltip"><img src="{{ url('/') }}/assets/images/icon/pencil(1)@2x.png"></a>
                         </td>
                       </tr>
                      <?php } } ?>
                      <?php 
