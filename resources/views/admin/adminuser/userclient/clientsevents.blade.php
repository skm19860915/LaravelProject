        ...
        <div class="card">
          <div class="card-header">
            <div class="back-btn-new" style="padding-top: 0; padding-left: 0;">
              <a href="{{ url('admin/userclient/clienttasks') }}">
           ...
           <div class="card-body">
             ...
             <div class="profile-new-client">
               <h2>Events</h2>
               <a href="{{ url('admin/userclient/createevent/')}}/{{$client->user_id}}" class="add-task-link">Create Event</a>
                      ...
                      if(!empty($event)) {
                        foreach ($event as $k => $v) {
                          echo '<tr>
                             ...
                             <td><a href="'.url('admin/userclient/clienteditevent/'.$client->user_id.'/'.$v->id).'" data-toggle="tooltip" title="Edit" class="action_btn"><img src="'.url('/').'/assets/images/icon/pencil(1)@2x.png"></a>';
                            // if($v->status) {
