        ...
        <div class="col-md-12">
          ...
          <div class="card-header">
            <div class="back-btn-new" style="padding-top: 0; padding-left: 0;">
              <a href="{{ url('firm/client/client_event') }}/{{$client->id}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20.2" height="13.772" viewBox="0 0 20.2 13.772"><g transform="translate(20.2 -129.506) rotate(90)"><g transform="translate(135.408)"><g transform="translate(0)"><path d="M238.913,0a.984.984,0,0,0-.984.984V18.921a.984.984,0,0,0,1.968,0V.984A.984.984,0,0,0,238.913,0Z" transform="translate(-237.929)"/></g></g><g transform="translate(129.506 12.723)"><g transform="translate(0)"><path d="M143.013,234.021a.984.984,0,0,0-1.39-.048l-5.231,4.883-5.231-4.882a.984.984,0,0,0-1.343,1.438l5.9,5.509a.983.983,0,0,0,1.342,0l5.9-5.509A.984.984,0,0,0,143.013,234.021Z" transform="translate(-129.506 -233.709)"/></g></g></g></svg> Back</a>
             </div>
            <!-- <a href="{{ url('firm/lead') }}" style="margin-right: 20px;"><i class="fas fa-long-arrow-alt-left"></i></a>
  ...
  <div class="modalformpart" id="modal-form-part" data-reschedule="<?php echo $reschedule; ?>" style="display: none;">
    ...
    <div class="row">  
      <div class="col-md-12 text-right">
        <input type="hidden" name="who_consult_with[]" value="{{ $id }}" >
        <input type="hidden" name="lead_id" value="{{ $client->id }}" >
        <input type="hidden" name="event_id" value="0" />  
        @csrf
        <input type="submit" name="save" value="Create Client Event" class="btn btn-primary saveclientinfo_form"/>
      </div>
    </div>
    </form>
  </div>
...
<script>
  $(document).ready(function(){
    ...
    $("#fire-modal-2").fireModal({title: 'Schedule a consult', body: $("#modal-form-part"), center: true});
    ...
    $('.saveclientinfo_form').on('click', function(e){
      ...
      <?php } ?>
	    $.ajax({
          ...
          res = JSON.parse(res);
          if(res.status) {
            window.location.href = "{{ url('admin/userclient/clientsevents') }}/{{$id}}";
          }
          else {
            alert(res.msg);
          }
  ...
  function delete_event_callback(){
    ...
    $.ajax({
        ...
        success:function(res)
        {       
          window.location.href = "{{ url('firm/client/create_event') }}/{{$id}}";
        }
      });
  };
