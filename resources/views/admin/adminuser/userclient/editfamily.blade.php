        ...
        <form action="{{ url('UpdateFamily') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
          ...
          <div class="card-body">
             ...
             <div class="form-client-edit-input">
              <div class="row">
               ...
               <div class="col-md-8 col-sm-8 col-xs-12">
                <?php 
                    $memail = '';
                    if (strpos($FamilyMember->email, 'dummy') !== false) {
                        '';
                    }
                    else {
                      $memail = $FamilyMember->email;
                    }
                  ?>
                  <input type="email" placeholder="Contact Email" name="email" class="form-control cls_{{$readonly}}"  value="{{$memail}}"> 
                  <input type="hidden" placeholder="Contact Email" name="oldemail" class="form-control cls_{{$readonly}}" required="required" value="{{$FamilyMember->email}}" readonly> 
            ...
            <div class="row">
             ...
             <div class="form-client-edit-input">
              <div class="row">
               ...
               <div class="col-md-8 col-sm-8 col-xs-12">
                <input type="text" placeholder="Cell Phone" name="phon_number" class="form-control cls_{{$readonly}} phone_no" value="{{$FamilyMember->phon_number}}" {{$readonly}}>                 
               </div>
              </div>
              </div>
             </div>
            ...
            <div class="row">
             ...
             <div class="form-client-edit-input">
              <div class="row">
               <div class="col-md-2 col-sm-2 col-xs-12"><label>Address L2</label></div>
               <div class="col-md-10 col-sm-10 col-xs-12">
                <input type="text" name="residence_address[address_l2]" class="form-control cls_{{$readonly}}" placeholder="Address" value="<?php if(!empty($FamilyMember->residence_address->address_l2)) { echo $FamilyMember->residence_address->address_l2; } ?>" {{$readonly}}>
               </div>
              </div>
              </div>
             </div>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-client-edit-input">
                  <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12">
                      <select class="form-control cls_{{$readonly}}" name="relationship" required="required" {{$readonly}}>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="form-client-edit-input">
                <div class="row">
                 ...
                 <div class="col-md-8 col-sm-8 col-xs-12">
                  <select class="form-control cls_{{$readonly}}" name="type" {{$readonly}}>
                    ...
                    <option value="Beneficiary" <?php if($FamilyMember->type == 'Beneficiary') { echo 'selected="selected"'; } ?>>Beneficiary</option>
                    <option value="Derivative Beneficiary" <?php if($FamilyMember->type == 'Derivative Beneficiary') { echo 'selected="selected"'; } ?>>Derivative Beneficiary</option>
                    <option value="Qualifying Family Member" <?php if($FamilyMember->type == 'Qualifying Family Member') { echo 'selected="selected"'; } ?>>Qualifying Family Member</option>
                    <option value="Applicant/Beneficiary" <?php if($FamilyMember->type == 'Applicant/Beneficiary') { echo 'selected="selected"'; } ?>>Applicant/Beneficiary</option>
                  </select>                 
                 </div>
                </div>
                </div>
              ...
              <input type="hidden" name="redirecturl" value="{{ url('admin/userclient/viewfamily') }}/{{$id}}">
