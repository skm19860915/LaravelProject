        ...
        <div class="col-md-12">
                    ...
                    <table class="table table-striped">
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$client->user_id}}" target="_blank" class="action_btn que_Petitioner" title="Edit" data-toggle="tooltip">
                                <img src="{{url('assets/images/icon/pencil(1)@2x.png')}}">
                              </a>
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$client->user_id}}?action=download" class="action_btn doclinkp doclinkpdd" title="Download" data-toggle="tooltip" target="_blank">
                              ...
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$client->user_id}}?action=print" class="action_btn doclink2 doclinkp doclinkppp" title="Print" data-toggle="tooltip" target="_blank">
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="height: 85%; fill: #949DB2;">
                                  <g>
                        ...
                        <!-- <tr>
                            ...
                            <td>
                              <a href="{{ url('edit_questionnaire/Beneficiary/en') }}/{{$client->user_id}}" target="_blank" class="action_btn que_Beneficiary" title="Edit" data-toggle="tooltip">
                                <img src="{{url('assets/images/icon/pencil(1)@2x.png')}}">
                              </a>
                          ...
                          foreach ($ques as $k => $v) { 
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="{{ url('edit_questionnaire') }}/{{$v->type}}/{{$v->id}}/{{$v->client_id}}?action=print" class="action_btn doclink2" title="Print" data-toggle="tooltip" target="_blank">
                                  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="height: 85%; fill: #949DB2;">
                                    <g>
                                      <path d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z">
                                      </path>
         ...
         <div class="row" style="display: none;">
          <div class="col-md-5">
           ...
           <?php //pre($client); 
           GetDataByClientInPDFForms($client->id); ?>
...
$(document).ready(function(){
  $('.que_lang').on('change', function(){
    var v = $(this).val();
    var l1 = "{{ url('edit_questionnaire/Beneficiary') }}/"+v+"/{{$client->user_id}}";
    var l2 = "{{ url('edit_questionnaire/Petitioner') }}/"+v+"/{{$client->user_id}}";
    $('.que_Beneficiary').attr('href', l1);
    $('.que_Petitioner').attr('href', l2);
    var doclinkpdd = "{{ url('edit_questionnaire/Petitioner') }}/"+v+"/{{$client->user_id}}?action=download";
    var doclinkppp = "{{ url('edit_questionnaire/Petitioner') }}/"+v+"/{{$client->user_id}}?action=print";
    if(v == 'es') {
