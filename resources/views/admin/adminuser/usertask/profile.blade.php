                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ url('edit_questionnaire/Petitioner/en') }}/{{$case->client_id}}?action=print" target="_blank" class="action_btn doclink2 doclinkp doclinkppp" title="Print" data-toggle="tooltip">
                                <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="height: 85%; fill: #949DB2;">
                                  <g>
                          ...
                          foreach ($ques as $k => $v) { 
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="{{ url('edit_questionnaire') }}/{{$v->type}}/{{$v->id}}/{{$v->client_id}}?action=download" target="_blank" class="action_btn" title="Download" data-toggle="tooltip">
                                  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="height: 85%; fill: #949DB2;">
                                    <g>
                                      <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path>
                                    </g>
