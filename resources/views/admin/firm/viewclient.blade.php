...
<div class="client-header-new">
  ...
  <div class="client-menu-box">
    <ul>
      ...
      <li><a class="{{ Request::route()->getName() == 'admin.firm.firm_users1' ? 'active-menu' : '' }}" href="{{ url('admin/firm/firm_users') }}/{{ $firm->id }}">Firm Users</a></li>
      <li><a class="{{ Request::route()->getName() == 'admin.firm.firm_users' ? 'active-menu' : '' }}" href="{{ url('admin/firm/firm_users') }}/{{ $firm->id }}">Notes</a></li>
      <li><a class="{{ Request::route()->getName() == 'admin.firm.firm_users1' ? 'active-menu' : '' }}" href="{{ url('admin/firm/firm_users') }}/{{ $firm->id }}">Billing</a></li>
    </ul>
  </div>
