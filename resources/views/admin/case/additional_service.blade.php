          ...
          <div class="card-body">
            <div class="profile-new-client">
             ...
             <div class="documents-list-box">
                <form action="{{url('admin/allcases/requestadditionalservice')}}" method="post">
                  <div class="table-responsive table-invoice">
                    <table class="table table table-bordered table-striped"  id="table" style="width: 99%;">
                      ...
                      if(!empty($additional_service->nvc_packet_quantity_new)) {
                      ...
                      <tr>
                       ...
                       <td> Request</th>
                       <td> 
                        <input type="checkbox" name="additional_service_new[]" data-cost="{{$I_864A_Cost}}" value="I-864A, Contract Between Sponsor and Household Member"></td>
                      </tr>
                      <?php } ?>
                      <tr>
                        <td colspan="6">
                      ...
                      <?php 
                      $service_exist1 = '';
                      if(!empty($additional_service) && false) {
                        $service_exist1 = $additional_service->additional_service1->additional_service1;
                        ?>
                          <tr>
                           <td> <?php echo $case->case_category; ?></td>
                           <td> <?php echo $case->case_type; ?></td>
                           <td> <?php echo $service_exist1; ?></td>
                           <td> $<?php echo $additional_service->additional_service1->additional_service1_cost; ?></td>
                           <td> 
                            <?php 
                                if($additional_service->additional_service1->status) {
                                  echo 'Selected';
                                }
                                else {
                                  echo 'Requested';
                      ...
                      <tr>
                        <td colspan="6">
                          <div class="text-right">
                            ...
                            <?php if(!empty($admintask)) { ?>
                            <input type="hidden" name="firm_admin_id" value="{{$admintask[0]->firm_admin_id}}" />
                            <?php } ?>
