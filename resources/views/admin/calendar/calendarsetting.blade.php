      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card-header">
            <a href="{{ url('admin/calendar') }}" style="margin-right: 20px;"><i class="fas fa-long-arrow-alt-left"></i></a>
            <h4></h4>
          ...
          <div class="card-body">
            <div class="modalformpart" id="modal-form-part">
              <form action="{{ url('admin/calendar/update_calendarsetting') }}" method="post" class="needs-validation" enctype="multipart/form-data" novalidate="">
              @if($users->isEmpty())  
...
<script>
  ...
  $(document).ready(function(){
    $('.saveclientinfo_form').on('click', function(e){
      ...
      $.ajax({
        type:"post",
        url:"{{ url('admin/calendar/update_calendarsetting') }}",
