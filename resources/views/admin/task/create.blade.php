        ...
        <form action="{{ url('admin/task/create_task') }}" method="post" class="needs-validation" novalidate="">
          ...
          <div class="card-body">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="hidden" name="redirect_url" value="{{ url('admin/task') }}">
                  @csrf
                  <button class="btn btn-primary createtaskbtn" type="submit" name="create_firm_Account">
                    <span>Create</span>
                  </button>
                </div>
              </div>
...
$(document).ready(function(){
  ...
  $('.createtaskbtn').on('click', function(){
    var v = $('select[name="vauser"]').val();
    if(v == undefined || v == '') {
      alert('Please select VP User');
    }
  })
});
</script>
