...
<section class="section client-listing-details task-new-header">
  <div class="section-header">
    <h1><a href="{{ url('admin/task') }}"><span>Task /</span></a> Update Task</h1>
  ...
  <div class="section-body">
  		<div class="row">
  			<div class="col-md-12">
  				<div class="card">
        <form action="{{ url('admin/task/update_task1') }}" method="post" class="needs-validation" novalidate="">
          ...
          <div class="card-body">
            ...
            <div class="form-group row mb-4">
              ...
              <div class="col-sm-12 col-md-7">
                <?php 
                $cln = '';
                if(empty($admintask->client_task)) { ?>
                <select class="selectpicker" name="firmclient" data-live-search="true">
                  ...
                  <?php } else {   ?>
                <?php foreach ($firmclient as $key => $value) { 
                  if ($value->id == $admintask->client_task) {
                    $cln = $value->name;
                  }
              } ?>
              <input type="text" class="form-control" value="{{$cln}}" readonly="readonly">
              <input type="hidden" name="firmclient" class="form-control" value="{{$admintask->client_task}}">
              <?php } ?>
