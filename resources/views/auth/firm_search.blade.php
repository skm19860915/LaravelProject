                            ...
                            <div class="col-md-6">
                                <div class="profile-new-client">
                                    ...
                                    if(!empty($result['users'])) {
                                        $rkcheck = false;
                                        echo '<h4>Users</h4><br><ul class="list-unstyled list-unstyled-border list-unstyled-noborder">';
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-links">
                                                    <a href="{{url('firm/users')}}">View</a>
                                                    <div class="bullet"></div>
                                                    <a href="{{url('firm/users/edit')}}/{{$user->id}}">Edit</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } echo '</ul>'; } ?>
                                    ...
                                    if(!empty($result['clients'])) {
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-links">
                                                    <a href="{{url('firm/client/client_case')}}/{{$client->id}}">View</a>
                                                    <div class="bullet"></div>
                                                    <a href="{{url('firm/client/edit')}}/{{$client->id}}">Edit</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } echo '</ul>'; } ?>
                                    ...
                                    if(!empty($result['family'])) {
                                        $rkcheck = false;
                                        echo '<br><br><h4>Family</h4><br><ul class="list-unstyled list-unstyled-border list-unstyled-noborder">';
                                        foreach ($result['family'] as $key => $f) { ?>
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-links">
                                                    <a href="{{url('firm/client/view_family')}}/{{$f->client_id}}">View</a>
                                                    <div class="bullet"></div>
                                                    <a href="{{url('firm/client/edit_family')}}/{{$f->client_id}}/{{$f->fid}}">Edit</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } echo '</ul>'; } ?>
                                    ...
                                    if(!empty($result['cases'])) {
                                        ...
                                        foreach ($result['cases'] as $key => $case) { ?>
                                            <li class="media">
                                                ...
                                                <div class="media-cta">
                                                  <a href="{{url('firm/case/show')}}/{{$case->id}}" class="btn btn-outline-primary">Detail</a>
                                                </div>
                                              </li>
                                    <?php } echo '</ul>'; } ?>
