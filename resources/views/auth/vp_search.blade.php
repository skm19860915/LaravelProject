                            ...
                            <div class="col-md-6">
                                <div class="profile-new-client">
                                    ...
                                    if(!empty($result['firms'])) {
                                        $rkcheck = false;
                                        echo '<h4>Firms</h4><br><ul class="list-unstyled list-unstyled-border list-unstyled-noborder">';
                                    ...
                                    if(!empty($result['clients'])) {
                                        ...
                                        <li class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="media-links">
                                                    <a href="{{url('admin/userclient/clientcases/')}}/{{$client->user_id}}">View</a>
                                                </div>
                                            </div>
                                        </li>
                                    <?php } echo '</ul>'; } ?>
                                    ...
                                    if(!empty($result['cases'])) {
                                        ...
                                        foreach ($result['cases'] as $key => $case) { ?>
                                            <li class="media">
                                                ...
                                                <div class="media-cta">
                                                  <a href="{{url('admin/usertask/overview')}}/{{$case->tid}}" class="btn btn-outline-primary">Detail</a>
                                                </div>
                                              </li>
                                    <?php } echo '</ul>'; } ?>
